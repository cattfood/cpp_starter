...
double make_sum (int n, const vector<int>& nums); // takes a number and a vector of numbers and sums the amount of numbers given
...
double make_sum (int n, const vector<int>& nums) {
    int sum = 0;
    if (n > nums.size()) {
        return nan("1");
    }
